...
?>
  ...
  <div class="wrapper">
	...
	?>
		...
		<div class="content">
		  <div style="width:30%; float:left"></p>
		    <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="230" height="683">
              ...
              <embed src="banner_ges.swf" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="230" height="683"></embed>
	        </object>
		    <table width="210" border="0" align="center">
              <tr>
                <td width="185"><div align="center"><img src="images/Logo-MOPROSOFT.jpg" alt="moprosoft" width="115" height="108" /></div></td>
              </tr>
              <tr>
                <td><div align="center" class="Estilo1">Nos complace informarle que   el d&iacute;a 13 de Julio pasado, hemos sido reconocidos con el Nivel 1 del Est&aacute;ndar de   Calidad MoProSoft (NMX-I-059/02 NYCE), que certifica que nuestras pr&aacute;cticas para   el desarrollo de software se apegan a los mejores est&aacute;ndares a nivel   internacional. <strong class="Estilo10"><span class="Estilo2">Ver</span> <a href="images/felicitacion.jpg">Ver m&aacute;s..<span class="Estilo32"><span class="Estilo44">.</span></span><span class="Estilo46"><img src="img/link.png" alt="l" width="20" height="20" border="0" /></span></a></strong></div></td>
              </tr>
            </table>
	      </div>
		  ...
		  <div style="width:66%; float: left">
		    <img src="img/tit_webges_2.jpg" alt="enc_webges" title="enc_webges" width="350" height="40" />	      </div>
		  <div style="width:20%; float: left">
		    <p><img src="images/img_webges.jpg" alt="img_webges" title="img_WebGes" /></p>
	      </div>
<div style="width:45%; float: right">
		    <p>Este software&nbsp;hace posible que los padres de familia vigilen la situaci&oacute;n particular de sus hijos, en aspectos tales como: calificaciones, tareas, estados de cuenta, pagos en l&iacute;nea, horarios, agenda, avisos, circulares, calendario escolar, etc. Por su parte los alumnos tambi&eacute;n podr&aacute;n acceder a esa informaci&oacute;n.</p>
		    <div style="width:97%; float:left"> 
	...
	<div style="width:70%; float:left">
	  <table width="549" height="143" border="0" align="center" bordercolor="#999999">
        ...
        <tr>
          <td><div align="right"><a href="grupoges_bibliotek.php"><img src="images/bibliotek.jpg" alt="img_bibliotek"  title="ico_Bibliotek" width="246" height="95" border="0" /></a></div></td>
    ...
    <div style="width:100%; float:left; background-image:url(images/copyright.png); background-repeat:no-repeat">
      <table width="757" height="43" border="0" align="center">
        <tr>
          ...
          <td width="243"><span class="Estilo9"><span class="Estilo10">|</span></span><span> <a href="grupoges_informes.php" class="pie">Solicitar Informes</a></span></td>
        </tr>
      </table>
      <p class="Estilo9">&nbsp;</p>
    </div>

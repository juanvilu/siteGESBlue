...
<head>
 ...
 <script language='Javascript'>
		...
		function validardatos() 
		{
		   ...
		   if( error == 0 )
		   {
				if ( (informes.realname.value == "") || (informes.cargo.value == "")  )  {
				   error = 1;
		   ...
		   if( error == 0 )
		   {
				if ( informes.colonia.value == "")  
				{
				   error = 1;
				   informes.colonia.focus();
...
?>
  ...
  <div class="wrapper">
    ...
    <input type="hidden" name="recipient" value="etrujillo@grupoges.com.mx">
    <input type="hidden" name="cc" value="susana@grupoges.com.mx,protecciondedatos@grupoges.com.mx">
    <input type="hidden" name="redirect" value="gracias_sce.htm">
    <input type="hidden" name="subject" value="Control Escolar GES - informes">
    <input type=hidden name="env_report" value="REMOTE_HOST,REMOTE_ADDR,HTTP_USER_AGENT">
	    ...
	    <table width="0%" border="0" cellpadding="0" cellspacing="0" bgcolor="#D1E9F3" class="F">
          ...
          <tr>
            ...
            <td valign="top"><select name="comoseentero" size="1" id="comoseentero" style="font-size:11px;">
              ...
              <option value="GES">Grupo GES</option>              

  ...
  <div class="wrapper">
	...
	<div class="content">
	  <div style="width:97%; float: left">
		    <h5 align="center"><img src="images/banner_comprar.jpg" alt="banner_distribuidores" title="banner Distribuidores" width="800" height="180" /></h5>
      </div>
		 
	  <div class="Estilo10" style="width:100%; float:left">  	
            <p>Somos el comercializador mayorista de la familia de productos Control Escolar GES en M&eacute;xico, con m&aacute;s de 10 a&ntilde;os de experiencia. Adem&aacute;s podr&aacute; adquirir estas soluciones a trav&eacute;s de una red alternativa de distribuidores en M&eacute;xico y Latinoam&eacute;rica.</p>
      </div>
	  <div class="Estilo10" style="width:100%; float:left">
	    <div align="center">
		<table width="100%" height="453" border="0" cellpadding="0" cellspacing="0">
			<tr>
			  <td valign="top">
                  <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="540" height="415">
                    <param name="movie" value="map_distrib_new.swf" />
                    <param name="quality" value="high" />
                    <param name="wmode" value="transparent" />
    				<param name="flashvars" value="cur_area=<?php echo $cur_area; ?>"/>
                    <embed src="map_distrib_new.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="540" height="415" wmode="transparent"></embed>
    		      </object>
                </td>
    ...
    $db_host = "grupoges.com.mx"; 
    $db_name = "grupoges_intranet";  // "escolar";	
    $db_user = "grupoges_admin";      //"root";
    $db_pass = "4Dm¡n"; // "";
